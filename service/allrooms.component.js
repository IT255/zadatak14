...
var AllRoomsComponent = (function () {
    ...
    AllRoomsComponent.prototype.removeRoom = function (event, item) {
        ...
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('token', localStorage.getItem('token'));
        this.http.get('http://localhost/hotel_exercise/deleteroom.php?id=' + item, { headers: headers }).subscribe(function (data) {
    ...
    AllRoomsComponent.prototype.updateRoom = function (item) {
