...
var AllRoomTypesComponent = (function () {
    ...
    AllRoomTypesComponent.prototype.removeRoomType = function (event, item) {
        ...
        headers.append('Content-Type', 'application/x-www-form-urlencoded');
        headers.append('token', localStorage.getItem('token'));
        this.http.get('http://localhost/hotel_exercise/deleteroomtype.php?id=' + item, { headers: headers }).subscribe(function (data) {
...
AllRoomTypesComponent = __decorate([
    core_1.Component({
        ...
        templateUrl: 'app/service/allroomtypes.component.html'
    }),
